...
| [2.7.1][2.7.1] |  Adobe Commerce 2.4.6-p3      | PHP 8.1 | Apache2.4  |
| [2.7.2][2.7.2] |  Adobe Commerce 2.4.7         | PHP 8.2 | Apache2.4  |
| [2.7.3][2.7.3] |  Adobe Commerce 2.4.7-p3      | PHP 8.3 | Apache2.4  |
| [2.7.4][2.7.4] |  Adobe Commerce 2.4.8-p1      | PHP 8.3 | Apache2.4  |
| [2.7.5][2.7.5] |  Adobe Commerce 2.4.8-p2      | PHP 8.4 | Apache2.4  |


> **Warning**.
> Adobe releases frequently new Adobe Commerce versions, fixing bugs and/or adding new functionallity. Some of this versions could be in conflict with this plugin. We highly encourage you to set up the configuration recommended in the guidance table for running correctly this extension.
...
[2.7.1]:https://github.com/saleslayer/magento-enterprise-plugin/releases/tag/2.7.1
[2.7.2]:https://github.com/saleslayer/magento-enterprise-plugin/releases/tag/2.7.2
[2.7.3]:https://github.com/saleslayer/magento-enterprise-plugin/releases/tag/2.7.3
[2.7.4]:https://github.com/saleslayer/magento-enterprise-plugin/releases/tag/2.7.4
[2.7.5]:https://github.com/saleslayer/magento-enterprise-plugin/releases/tag/2.7.5
